 ...
 */
TimeTracker.prototype._track = function(tracker, opt_event_obj_name, opt_event_label) {
  var eventTracker;
  ...
  //alert(bucketString);
  //alert(opt_event_label);
  //alert(this._getTimeDiff());
  //eventTracker._trackEvent(bucketString, opt_event_label, this._getTimeDiff());
  eventTracker._trackEvent('TimeTracker', '(' + bucketString + ') ' + opt_event_label, this._getTimeDiff());
};
