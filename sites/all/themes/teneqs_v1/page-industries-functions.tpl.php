...
<script>
  ...
  <script type="text/javascript" src="<?php echo $base_path . path_to_theme() . '/js/mouseover-tracker.js'; ?>"></script>
  <script type="text/javascript" src="<?php echo $base_path . path_to_theme() . '/js/time-tracker.js'; ?>"></script>
  <script type="text/javascript" src="<?php echo $base_path . path_to_theme() . '/js/matrix.js'; ?>"></script>
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $(".fancybox").fancybox(); /* fancybox (lightbox) */
        show_matrix(); /* build and display matrix */
      });
      //pageTracker = _gat._getTracker('UA-27571118-1');
      
      //pageTracker = _gat._getTracker('<?php echo $env_webserver == 'local' || $env_webserver == 'dev' ? 'UA-27991560-1' : 'UA-9891954-5'; ?>');
      ga(function() {
        pageTracker = ga.getByName('t0');
      });
        /*ga(function() {
          var trackers = ga.getAll();
          for (var i=0; i < trackers.length; ++i) {
            //var tracker = trackers[i];
            pageTracker = trackers[i];
            break;
...
<body class="<?php print $body_classes; ?>">
  <div id="wrap">
    ...
    <div id="main" class="two-column">
      ...
      <?php endif; ?>
      <?php if ($content) { ?>
	    <div id="content-area" class="column-left column-left-full-width">
	      <?php print $content; ?>
		</div>
	  <?php } ?>
      <?php if ($right): ?>
...
<script type="text/javascript">
  ...
  //timeTracker._track(pageTracker, 'case-study-matrix', 'TimeTracker');
</script>
</html>