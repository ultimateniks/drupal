<?php include('header.tpl.php') ?>
    <div id="main" class="template3"><div id="main-inner" class="clear-block<?php if ($search_box || $primary_links || $secondary_links || $navbar) { print ' with-navbar'; } ?>">
    ...
    <div id="homepage_content_bottom" class="region region-homepage_content_bottom">
